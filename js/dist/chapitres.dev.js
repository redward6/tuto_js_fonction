...
var tab_fonts = ["Sedgwick Ave Display", "Shadows Into Light", "Architects Daughter", "Grand Hotel", "Lobster", "Mali", "Patrick Hand", "cursive", 'Roboto', 'Pacifico', "Orbitron", "Langar", "Fredoka One", 'Dancing Script', 'Courgette', 'Bungee', 'Anton', 'Amatic SC'];
var tab_couleur = ["#F24957", "#BF3F61", "#8C3264", "#281B59", "#010326", "#090F29", "#203F5C", "#8F437A", "#C21657", "#F54333", "#27615F", "#090F29", "#F50604", "#32005C", "#C21657", "#5C17A8", "#6F068F", "#20029C", "#9C023D"]; // Tableau que je vais incrémenter pour afficher le prénom des étudiants dans l'ordre, dans la lopp en bas de page avec i++

var tab_etudiants = ["Numa", "Nabil", "Ruddy", "Kheira", "Clara", "RomainG", "Pierre", "Mohammed", "RomainD", "Stephane", "Sonia", "Loic", "Priscille", "Tiffany", "Khalil", "Straydine", "Nicolas", "Veronica", "Francisco", "Nawal", "Colin", "Thomas"]; // console.log(tab_fonts[Math.floor(Math.random() * tab_fonts.length)]);
...
/*#__PURE__*/
function () {
  function NouveauChapitre(index, mon_h1, mon_para, couleur_txt, couleur_bg, police, klass) {
    _classCallCheck(this, NouveauChapitre);
  ...
  _createClass(NouveauChapitre, [{
    key: "afficher",
    value: function afficher() {
      var mon_titre = document.createElement("h1");
      var mon_paragraphe = document.createElement("p");
      var ma_section = document.createElement("section"); //                                            0 + 1 = 1
      ...
      if (this.police == 'Bungee') {
        mon_titre.style.fontSize = "1.4em";
        mon_paragraphe.style.fontSize = "1.4em";
      } else if (this.mon_para == "Nabil") {
        mon_paragraphe.style.fontWeight = "bold";
        mon_paragraphe.style.fontSize = "3em";
    ...
    key: "change_color",
    value: function change_color(une_couleur) {
...
var un_h1 = "Bonjour je suis un h1";
var un_para = "Salut je suis un paragraphe";

function execution() {
  //    compteur a 0; compteur plus petit que 22 tu m'augmente le compteur de 1
  for (var i = 0; i < tab_etudiants.length; i++) {
    var chapo = new NouveauChapitre(i, un_h1, tab_etudiants[i], "white", tab_couleur[Math.floor(Math.random() * tab_couleur.length)], tab_fonts[Math.floor(Math.random() * tab_fonts.length)], "ma_classe_css" + (i + 1));
    chapo.afficher();
  }
}

function just_one() {
  var chapi = new NouveauChapitre(0, un_h1, tab_etudiants[Math.floor(Math.random() * tab_couleur.length)], "white", tab_couleur[Math.floor(Math.random() * tab_couleur.length)], tab_fonts[Math.floor(Math.random() * tab_fonts.length)], "ma_classe_css" + (0 + 1));
  chapi.afficher();
}
...
function delete_child() {
  var e = document.getElementById("container_section");
...
var bouton_clean = document.createElement("div");
...
var bouton_div = document.createElement("div");
...
var bouton_one = document.createElement("div");
...
var container_section = document.createElement("div");
